...
public class RecentsView extends FrameLayout implements TaskStackView.TaskStackViewCallbacks,
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        boolean mShowSearchView = Settings.System.getInt(resolver,
                    Settings.System.RECENTS_SHOW_HIDE_SEARCH_BAR, 0) != 0;
        int padding = mShowSearchView
                ? mContext.getResources().getDimensionPixelSize(R.dimen.recents_search_bar_space_height + 25)
                : mContext.getResources().getDimensionPixelSize(R.dimen.status_bar_header_height);
        mMemBar.setPadding(0, padding, 0, 0);
        mMemText.setPadding(0, padding, 0, 0);
        showMemDisplay();
