        ...
        if (mButtonLayouts == 1) {
			...
			if (!showingIME) {
				if ((LayoutChangerButtonView) getButtonView(ACTION_LAYOUT_LEFT) != null)
						((LayoutChangerButtonView) getButtonView(ACTION_LAYOUT_LEFT)).setDrawingAlpha(0.18f);
				if ((LayoutChangerButtonView) getButtonView(ACTION_LAYOUT_RIGHT) != null)
						((LayoutChangerButtonView) getButtonView(ACTION_LAYOUT_RIGHT)).setDrawingAlpha(0.18f);
			}
        }
    }
